    ...
    for root_folder, _, list_of_file_names in os.walk(destination_resolved_folder):
        for file in list_of_file_names:
            ...
            if content:
                ...
                #     #If a PermissionError occurs (file is locked), move it to Trash
                #     if os.path.exists(broken_file_start_file_path):
                #         # Move the file to Trash
                #         trash_folder = os.path.expanduser("~/.Trash")
                #         shutil.move(broken_file_start_file_path, os.path.join(trash_folder, file))
                #         print(f"Moved locked file to Trash: {broken_file_start_file_path}")

                #         #Increment.
                #         counter_error_permission_error_led_to_trash += 1
                #     else:
                #         print(f"File does not exist: {broken_file_start_file_path}")
...
#What to input into Command Prompt in MacBook:
    ...
    #2) python3 encode_files_edit9.py 
